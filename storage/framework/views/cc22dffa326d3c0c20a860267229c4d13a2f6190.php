<?php $__env->startSection('content'); ?>
    <?php echo e(Form::model($data,['url' => url('panel/portfolio/'.$data->id), 'class' => 'form-horizontal ajax-submit', 'role' => 'form', 'id' => 'form'])); ?>
                ...
                <div class="col-md-9">
                 <input type="hidden" name="save" id="saveMethod" value="">
                    ...
                    <button class="btn btn-sm btn-save pull-left bg-green" data-content="3" type="submit" style="width:160px"
                        ...
                        <span class="fa fa-check"></span>
                        <?php echo app('translator')->getFromJson('form.copy_save'); ?>
                    </button>
                </div>
            </div>
        </div>
                            ...
                            <div class="row">
                                <div class="col-md-2">
                                    <ul class="nav nav-tabs" role="tablist">
                                        <li class="nav-item"><a class="nav-link active" data-toggle="tab" href="#details"><i class="zmdi zmdi-view-toc"></i> <?php echo app('translator')->getFromJson('general.detail'); ?> </a></li>
                                    ...
                                    <div class="tab-content">
                                        ...
                                        <div role="tabpanel" class="tab-pane in active" id="details">
                                            ...
                                            <div class="row clearfix">
                                                ...
                                                <div class="col-lg-10 col-md-10 col-sm-8">
                                                    <div class="previewCont empty22">
                                                        <img src="<?php echo e(url($data->default_image)); ?>" alt="" id="runtime_defaultImage">
                                                    </div>
                                                    ...
                                                    <div class="input-group dirleft">
                                                        ...
                                                        <?php echo e(Form::text('default_image', $data->default_image, ['class' => 'form-control textright pfDefaultImage', 'id' => 'defaultImage','style' => 'height:82px;'])); ?>
                                            ...
                                            <div class="row clearfix">
                                                ...
                                                <div class="col-lg-10 col-md-10 col-sm-8">
                                                    <?php echo e(Form::textarea('text',$data->description, ['class' => 'ckeditor', 'cols' => 100, 'rows' => 10])); ?>
                                        ...
                                        <div role="tabpanel" class="tab-pane" id="standard">
                                            ...
                                            <div class="row clearfix">
                                                ...
                                                <div class="col-lg-10 col-md-10 col-sm-8">
                                                    <div class="previewCont empty22">
                                                        <img src="<?php echo e(url($data->standard_image)); ?>" alt="" id="runtime_standard_image">
                                                    </div>
                                                    <a href="" class="text-danger delete-row1 delete-row col-md-1">
                                                        <i class="fa fa-trash"></i>
                                                    </a>
                                                    <div class="input-group dirleft">
                                                        ...
                                                        <?php echo e(Form::text('standard_image', $data->standard_image, ['class' => 'form-control textright', 'id' => 'standard_image','style' => 'height:82px;'])); ?>
                                            ...
                                            <div class="row clearfix">
                                                ...
                                                <div class="col-lg-10 col-md-10 col-sm-8">
                                                    <?php echo e(Form::textarea('standard_text', $data->standard_text , ['class' => 'ckeditor', 'cols' => 100, 'rows' => 10])); ?>
                                        ...
                                        <div role="tabpanel" class="tab-pane" id="usages">
                                            ...
                                            <div class="row clearfix">
                                                ...
                                                <div class="col-lg-10 col-md-10 col-sm-8">
                                                    <div class="previewCont empty22">
                                                        <img src="<?php echo e(url($data->usages_image)); ?>" alt="" id="runtime_usage_image">
                                                    </div>
                                                    <a href="" class="text-danger delete-row1 delete-row col-md-1">
                                                        <i class="fa fa-trash"></i>
                                                    </a>
                                                    <div class="input-group dirleft">
                                                        ...
                                                        <?php echo e(Form::text('usages_image', $data->usages_image, ['class' => 'form-control textright pfDefaultImage', 'id' => 'usages_image','style' => 'height:82px;'])); ?>
                                            ...
                                            <div class="row clearfix">
                                                ...
                                                <div class="col-lg-10 col-md-10 col-sm-8">
                                                    <?php echo e(Form::textarea('usages_text', $data->usages_text, ['class' => 'ckeditor', 'cols' => 100, 'rows' => 10])); ?>
                                        ...
                                        <div role="tabpanel" class="tab-pane" id="mazaya">
                                            ...
                                            <div class="row clearfix">
                                                ...
                                                <div class="col-lg-10 col-md-10 col-sm-8">
                                                    <div class="previewCont empty22">
                                                        <img src="<?php echo e(url($data->mazaya_image)); ?>" alt="" id="runtime_mazaya_image">
                                                    </div>
                                                    <a href="" class="text-danger delete-row1 delete-row col-md-1">
                                                        <i class="fa fa-trash"></i>
                                                    </a>
                                                    <div class="input-group dirleft">
                                                        ...
                                                        <?php echo e(Form::text('mazaya_image', $data->mazaya_image, ['class' => 'form-control textright pfDefaultImage', 'id' => 'mazaya_image','style' => 'height:82px;'])); ?>
                                            ...
                                            <div class="row clearfix">
                                                ...
                                                <div class="col-lg-10 col-md-10 col-sm-8">
                                                    <?php echo e(Form::textarea('mazaya_text', $data->mazaya_text, ['class' => 'ckeditor', 'cols' => 100, 'rows' => 10])); ?>
                                        ...
                                        <div role="tabpanel" class="tab-pane" id="vizhegi">
                                            ...
                                            <?php $__currentLoopData = $vizhegies; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <div class="vizhegiPack ">
                                                    <div class="row clearfix" style="border-top: 1px solid #ccc;">
                                                        <div class="col-md-6">
                                                            <div class="form-group">
                                                                <label for="">ویژگی</label>
                                                                <input type="text" value="<?php echo e($key); ?>" class="form-control" placeholder="" name="vizhegi_key[]">
                                                            </div>
                                                        </div>
                                                        <div class="col-md-6">
                                                            <div class="form-group">
                                                                <label for="">توضیحات</label>
                                                                <input type="text" value="<?php echo e($value); ?>" class="form-control" placeholder="" name="vizhegi_value[]">
                                                            </div>
                                                        </div>
                                        ...
                                        <div role="tabpanel" class="tab-pane" id="masraf">
                                            ...
                                            <div class="row clearfix">
                                                ...
                                                <div class="col-lg-10 col-md-10 col-sm-8">
                                                    <div class="previewCont empty22">
                                                        <img src="<?php echo e(url($data->masraf_image)); ?>" alt="" id="runtime_masaref_image">
                                                    </div>
                                                    <a href="" class="text-danger delete-row1 delete-row col-md-1">
                                                        <i class="fa fa-trash"></i>
                                                    </a>
                                                    <div class="input-group dirleft">
                                                        ...
                                                        <?php echo e(Form::text('masraf_image', $data->masraf_image, ['class' => 'form-control textright pfDefaultImage', 'id' => 'masraf_image','style' => 'height:82px;'])); ?>
                                            ...
                                            <div class="row clearfix">
                                                ...
                                                <div class="col-lg-10 col-md-10 col-sm-8">
                                                    <?php echo e(Form::textarea('masraf_text', $data->masraf_text, ['class' => 'ckeditor', 'cols' => 100, 'rows' => 10])); ?>
                                        ...
                                        <div role="tabpanel" class="tab-pane" id="amadesazi">
                                            ...
                                            <div class="row clearfix">
                                                ...
                                                <div class="col-lg-10 col-md-10 col-sm-8">
                                                    <div class="previewCont empty22">
                                                        <img src="<?php echo e(url($data->amadesazi_image)); ?>" alt="" id="runtime_amadesazi_image">
                                                    </div>
                                                    <a href="" class="text-danger delete-row1 delete-row col-md-1">
                                                        <i class="fa fa-trash"></i>
                                                    </a>
                                                    <div class="input-group dirleft">
                                                        ...
                                                        <?php echo e(Form::text('amadesazi_image', $data->amadesazi_image, ['class' => 'form-control textright pfDefaultImage', 'id' => 'amadesazi_image','style' => 'height:82px;'])); ?>
                                            ...
                                            <div class="row clearfix">
                                                ...
                                                <div class="col-lg-10 col-md-10 col-sm-8">
                                                    <?php echo e(Form::textarea('amadesazi_text', $data->amadesazi_text, ['class' => 'ckeditor', 'cols' => 100, 'rows' => 10])); ?>
                                        ...
                                        <div role="tabpanel" class="tab-pane" id="sakht">
                                            ...
                                            <div class="row clearfix">
                                                ...
                                                <div class="col-lg-10 col-md-10 col-sm-8">
                                                    <div class="previewCont empty22">
                                                        <img src="<?php echo e(url($data->sakht_image)); ?>" alt="" id="runtime_sakht_image">
                                                    </div>
                                                    <a href="" class="text-danger delete-row1 delete-row col-md-1">
                                                        <i class="fa fa-trash"></i>
                                                    </a>
                                                    <div class="input-group dirleft">
                                                        ...
                                                        <?php echo e(Form::text('sakht_image', $data->sakht_image, ['class' => 'form-control textright pfDefaultImage', 'id' => 'sakht_image','style' => 'height:82px;'])); ?>
                                            ...
                                            <div class="row clearfix">
                                                ...
                                                <div class="col-lg-10 col-md-10 col-sm-8">
                                                    <?php echo e(Form::textarea('sakht_text', $data->sakht_text, ['class' => 'ckeditor', 'cols' => 100, 'rows' => 10])); ?>
                                        ...
                                        <div role="tabpanel" class="tab-pane" id="ejra">
                                            ...
                                            <div class="row clearfix">
                                                ...
                                                <div class="col-lg-10 col-md-10 col-sm-8">
                                                    <div class="previewCont empty22">
                                                        <img src="<?php echo e(url($data->ejra_image)); ?>" alt="" id="runtime_ejra_image">
                                                    </div>
                                                    <a href="" class="text-danger delete-row1 delete-row col-md-1">
                                                        <i class="fa fa-trash"></i>
                                                    </a>
                                                    <div class="input-group dirleft">
                                                        ...
                                                        <?php echo e(Form::text('ejra_image', $data->ejra_image, ['class' => 'form-control textright pfDefaultImage', 'id' => 'ejra_image','style' => 'height:82px;'])); ?>
                                            ...
                                            <div class="row clearfix">
                                                ...
                                                <div class="col-lg-10 col-md-10 col-sm-8">
                                                    <?php echo e(Form::textarea('ejra_text', $data->ejra_text, ['class' => 'ckeditor', 'cols' => 100, 'rows' => 10])); ?>
                                        ...
                                        <div role="tabpanel" class="tab-pane" id="negahdari">
                                            ...
                                            <div class="row clearfix">
                                                ...
                                                <div class="col-lg-10 col-md-10 col-sm-8">
                                                    <div class="previewCont empty22">
                                                        <img src="<?php echo e(url($data->negahdari_image)); ?>" alt="" id="runtime_standard_image">
                                                    </div>
                                                    <a href="" class="text-danger delete-row1 delete-row col-md-1">
                                                        <i class="fa fa-trash"></i>
                                                    </a>
                                                    <div class="input-group dirleft">
                                                        ...
                                                        <?php echo e(Form::text('negahdari_image', $data->negahdari_image, ['class' => 'form-control textright pfDefaultImage', 'id' => 'negahdari_image','style' => 'height:82px;'])); ?>
                                            ...
                                            <div class="row clearfix">
                                                ...
                                                <div class="col-lg-10 col-md-10 col-sm-8">
                                                    <?php echo e(Form::textarea('negahdari_text', $data->negahdari_text, ['class' => 'ckeditor', 'cols' => 100, 'rows' => 10])); ?>
                                        ...
                                        <div role="tabpanel" class="tab-pane" id="time">
                                            ...
                                            <div class="row clearfix">
                                                ...
                                                <div class="col-lg-10 col-md-10 col-sm-8">
                                                    <div class="previewCont empty22">
                                                        <img src="<?php echo e(url($data->time_image)); ?>" alt="" id="runtime_time_image">
                                                    </div>
                                                    <a href="" class="text-danger delete-row1 delete-row col-md-1">
                                                        <i class="fa fa-trash"></i>
                                                    </a>
                                                    <div class="input-group dirleft">
                                                        ...
                                                        <?php echo e(Form::text('time_image', $data->time_image, ['class' => 'form-control textright pfDefaultImage', 'id' => 'time_image','style' => 'height:82px;'])); ?>
                                            ...
                                            <div class="row clearfix">
                                                ...
                                                <div class="col-lg-10 col-md-10 col-sm-8">
                                                    <?php echo e(Form::textarea('time_text', $data->time_text, ['class' => 'ckeditor', 'cols' => 100, 'rows' => 10])); ?>
                                        ...
                                        <div role="tabpanel" class="tab-pane" id="imeni">
                                            ...
                                            <div class="row clearfix">
                                                ...
                                                <div class="col-lg-10 col-md-10 col-sm-8">
                                                    <div class="previewCont empty22">
                                                        <img src="<?php echo e(url($data->imeni_image)); ?>" alt="" id="runtime_imeni_image">
                                                    </div>
                                                    <a href="" class="text-danger delete-row1 delete-row col-md-1">
                                                        <i class="fa fa-trash"></i>
                                                    </a>
                                                    <div class="input-group dirleft">
                                                        ...
                                                        <?php echo e(Form::text('imeni_image', $data->imeni_image, ['class' => 'form-control textright pfDefaultImage', 'id' => 'imeni_image','style' => 'height:82px;'])); ?>
                                            ...
                                            <div class="row clearfix">
                                                ...
                                                <div class="col-lg-10 col-md-10 col-sm-8">
                                                    <?php echo e(Form::textarea('imeni_text', $data->imeni_text, ['class' => 'ckeditor', 'cols' => 100, 'rows' => 10])); ?>
                                        ...
                                        <div role="tabpanel" class="tab-pane" id="fanni">
                                            ...
                                            <div class="row clearfix">
                                                ...
                                                <div class="col-lg-10 col-md-10 col-sm-8">
                                                    <div class="previewCont empty22">
                                                        <img src="<?php echo e(url($data->fanni_image)); ?>" alt="" id="runtime_fanni_image">
                                                    </div>
                                                    <a href="" class="text-danger delete-row1 delete-row col-md-1">
                                                        <i class="fa fa-trash"></i>
                                                    </a>
                                                    <div class="input-group dirleft">
                                                        ...
                                                        <?php echo e(Form::text('fanni_image', $data->fanni_text, ['class' => 'form-control textright pfDefaultImage', 'id' => 'fanni_image','style' => 'height:82px;'])); ?>
                                            ...
                                            <div class="row clearfix">
                                                ...
                                                <div class="col-lg-10 col-md-10 col-sm-8">
                                                    <?php echo e(Form::textarea('fanni_text', $data->fanni_text, ['class' => 'ckeditor', 'cols' => 100, 'rows' => 10])); ?>
