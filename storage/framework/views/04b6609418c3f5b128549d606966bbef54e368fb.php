...
<head>
  ...
  <style>
    ...
    th{
      text-align: <?php echo e(trans('general.right')); ?>;
      font-weight: bold;
    }
    input[accept="image/jpeg,image/pjpeg,image/png,image/gif,image/svg+xml,application/pdf,text/plain,video/mp4"]{
      right:0px;
      left:auto;
    }
  </style>
</head>
<body dir="<?php echo e(trans('general.direction')); ?>" >
  <div class="container-fluid" id="wrapper">
    ...
    <div class="row">
      ...
      <div class="col-sm-10 col-xs-12 pull-right" id="main">
