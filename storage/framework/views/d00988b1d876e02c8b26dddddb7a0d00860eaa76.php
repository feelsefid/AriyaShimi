    ...
    <?php $__currentLoopData = $data; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        <tr style="direction: ltr; text-align: right">
            ...
            <td>
                ...
                <a href="<?php echo e(url('panel/article/' . $row->id . '/edit')); ?>">
                <?php endif; ?>
                    <?php echo e($row->name); ?>
            ...
            <td class="text-center"><?php echo e($row->article_categories->name); ?></td>
            <td class="text-center"><?php echo e($row->language); ?></td>
            <td class="text-center">
                <?php if (Auth::check() && Auth::user()->can('edit.article')): ?>
                <a class="action status" data-value="<?php echo e($row->status == 1 ? 2 : 1); ?>" data-id="<?php echo e($row->id); ?>" href="<?php echo e(url('panel/article/status')); ?>">
                <?php endif; ?>
                    <?php if($row->status=="1"): ?>
