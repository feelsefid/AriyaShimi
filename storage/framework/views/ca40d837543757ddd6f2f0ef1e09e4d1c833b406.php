...
<?php $__env->startSection('seo'); ?>
    <meta name="description" content="<?php echo e($setting->description_seo); ?>">
    <meta name="keywords" content="<?php echo e($setting->keyword_seo); ?>">
...
<article id="post-135" class="post-135 btx-content-wrapper post type-post status-publish format-standard has-post-thumbnail hentry category-lifestyle category-travel tag-ocean tag-sail tag-trip">
                <div class="btx-post btx-post--magazine btx-post--no-sidebar btx-post-format--standard btx-post-featured--overlap">
                                    ...
                                    <div class="btx-col-10">
                                        <div class="btx-item js-item-heading btx-heading btx-heading--plain btx-center-align btx-uppercase" >
                                            <h3 class="btx-heading-text btx-secondary-font btx-s-text-color btx-s-text-border">
                                                <span class="font-style" style="font-size: 16px;"><?php echo e($portfolio->name); ?></span>
                                            </h3>
                                        </div>
                                        ...
                                        <div class="btx-item js-item-image btx-image btx-center-align" >
                                            <div class="btx-image-container">
                                                <img src="<?php echo e(url($portfolio->default_image)); ?>" alt=""  width="768" height="512" />
                                            </div>
                                        </div>
                                            ...
                                            <div class="btx-interactive-space btx-interactive-space--normal btx-dark-scheme">
                                                <div class="btx-background" data-type="image" data-parallaxspeed="0" data-contentfade="" data-mobileparallax="">
                                                    <div class="btx-background-wrapper">
                                                        <div class="btx-background-inner" style="background-image:url(<?php echo e(url($portfolio->standard_image)); ?>); background-size:cover; background-position:center center; background-repeat:repeat;"></div>
                                                    </div>
                                                ...
                                                <div class="btx-interactive-content" style="padding-top:40px; padding-right:40px; padding-left:40px; padding-bottom:40px;">
                                                    <div class="btx-item js-item-text btx-text btx-center-align btx-primary-font">
                                                        <div class="btx-row" style="margin:0 -30px;">
                                                            <div class="btx-text-content btx-col-12" style="padding:0 30px;">
                                                                <div class="btx-text-content-inner">
                                                                    <br><span style="color: rgb(255, 255, 255);"><?php echo e($portfolio->standard_text); ?></span>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                    ...
                                    <div class="btx-col-4 float-right">
                                        <div class="btx-item js-item-interactive btx-interactive btx-interactive--overlay btx-p-border-border btx-interactive--overlay-fadein" style="height:300px; line-height:300px;">
                                            <div class="btx-interactive-space btx-interactive-space--normal btx-light-scheme">
                                                <div class="btx-background" data-type="image" data-parallaxspeed="0" data-contentfade="" data-mobileparallax="">
                                                    <div class="btx-background-wrapper">
                                                        <div class="btx-background-inner" style="background-image:url(<?php echo e(url($portfolio->usages_image)); ?>); background-size:cover; background-position:center center; background-repeat:repeat;"></div>
                                                    </div>
                                                            ...
                                                            <div class="btx-text-content btx-col-12" style="padding:0 30px;">
                                                                <div class="btx-text-content-inner">
                                                                    <br><span style="color: rgb(255, 255, 255);">
                                                                        <?php echo e($portfolio->usages_text); ?>
                                    ...
                                    <div class="btx-col-4 float-right">
                                        <div class="btx-item js-item-interactive btx-interactive btx-interactive--overlay btx-p-border-border btx-interactive--overlay-fadein" style="height:300px; line-height:300px;">
                                            <div class="btx-interactive-space btx-interactive-space--normal btx-light-scheme">
                                                <div class="btx-background" data-type="image" data-parallaxspeed="0" data-contentfade="" data-mobileparallax="">
                                                    <div class="btx-background-wrapper">
                                                        <div class="btx-background-inner" style="background-image:url(<?php echo e(url($portfolio->mazaya_image)); ?>); background-size:cover; background-position:center center; background-repeat:repeat;"></div>
                                                    </div>
                                                            ...
                                                            <div class="btx-text-content btx-col-12" style="padding:0 30px;">
                                                                <div class="btx-text-content-inner">
                                                                    ...
                                                                    <span style="color: rgb(34, 34, 34);">
                                                                        <?php echo e($portfolio->mazaya_text); ?>
                                                    ...
                                                    <div class="btx-item js-item-table btx-table btx-table--standard btx-right-align direction-rtl table-responsive">
                                                        <table>
                                                            ...
                                                            <tr class="btx-table-body-row ">
                                                                <td style="width:40%;"><span style="color: rgb(48, 48, 48);"><?php echo e($key); ?></span></td>
                                                                <td style="width:30%;"><?php echo e($value); ?></td>
                                                            </tr>
                                    ...
                                    <div class="btx-col-6 float-right">
                                        <div class="btx-item js-item-interactive btx-interactive btx-interactive--flip btx-p-border-border" style="border-width:1px; border-color:#eeeeee; height:400px; line-height:400px;">
                                            <div class="btx-interactive-space btx-interactive-space--normal btx-light-scheme">
                                                <div class="btx-background" data-type="image" data-parallaxspeed="0" data-contentfade="" data-mobileparallax="">
                                                    <div class="btx-background-wrapper">
                                                        <div class="btx-background-inner" style="background-image:url(<?php echo e(url($portfolio->masraf_image)); ?>); background-size:cover; background-position:center center; background-repeat:repeat;"></div>
                                                    </div>
                                                            ...
                                                            <div class="btx-skill-item btx-col-12" data-percent="88" data-axis="horizontal">
                                                                <div class="btx-skill-heading text-justify">
                                                                    <span class="btx-s-text-color">
                                                                        <?php echo e($portfolio->masraf_text); ?>
                                    ...
                                    <div class="btx-col-6 float-right">
                                        <div class="btx-item js-item-interactive btx-interactive btx-interactive--flip btx-p-border-border" style="border-width:1px; border-color:#eeeeee; height:400px; line-height:400px;">
                                            <div class="btx-interactive-space btx-interactive-space--normal btx-light-scheme">
                                                <div class="btx-background" data-type="image" data-parallaxspeed="0" data-contentfade="" data-mobileparallax="">
                                                    <div class="btx-background-wrapper">
                                                        <div class="btx-background-inner" style="background-image:url(<?php echo e(url($portfolio->amadesazi_image)); ?>); background-size:cover; background-position:center center; background-repeat:repeat;"></div>
                                                    </div>
                                                    <div class="btx-background-overlay " style="background-color: #000000; opacity:0.6;"></div>
                                                </div>
                                                <div class="btx-interactive-content" style="padding-top:60px; padding-right:60px; padding-left:60px; padding-bottom:60px;">
                                                ...
                                                <div class="btx-interactive-content" style="padding-top:60px; padding-right:60px; padding-left:60px; padding-bottom:60px;">
                                                    <div class="btx-item js-item-skill btx-skill btx-skill--bar btx-skill--horizontal">
                                                        <div class="btx-row">
                                                            <div class="btx-skill-item btx-col-12" data-percent="88" data-axis="horizontal">
                                                                <div class="btx-skill-heading text-justify">
                                                                    <span class="btx-s-text-color"><?php echo e($portfolio->amadesazi_text); ?></span>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                    ...
                    <section class="btx-section js-dynamic-navbar btx-p-border-border btx-dark-scheme" data-index="4" data-scheme="dark">
                        <div class="btx-background" data-type="image" data-parallaxspeed="2" data-contentfade="" data-mobileparallax="">
                            <div class="btx-background-wrapper">
                                <div class="btx-background-inner" style="background-image:url(<?php echo e(url($portfolio->sakht_image)); ?>); background-size:cover; background-position:center center; background-repeat:repeat;"></div>
                            </div>
                                                    ...
                                                    <div class="btx-box-body" >
                                                        <div class="btx-item js-item-quote btx-quote btx-quote--standard btx-center-align btx-with-background" >
                                                            ...
                                                            <div class="btx-quote-text btx-s-text-color btx-custom_c-font text-right">
                                                                <span class="font-style direction-rtl" style="font-size: 13px;"><?php echo e($portfolio->sakht_text); ?></span>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                                                ...
                                                                <div class="btx-text-content btx-col-12" style="padding:0 30px;">
                                                                    <div class="btx-text-content-inner direction-rtl text-justify">
                                                                        <span class="font-style" style="font-size: 13px;">
                                                                            <?php echo e($portfolio->ejra_text); ?>
                                                ...
                                                <div class="btx-box-content btx-middle-vertical" style="overflow-y:hidden;">
                                                    <div class="btx-box-body" >
                                                        <div class="btx-item js-item-image btx-image btx-center-align anmt-item anmt-fadeinu" style="margin-right:5%; margin-left:20%;">
                                                            <div class="btx-image-container">
                                                                <img src="<?php echo e(url($portfolio->ejra_image)); ?>" alt="" style="max-width:100%;" width="488" height="1200"  />
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                    ...
                                    <div class="btx-col-4 float-right">
                                        <div class="btx-item js-item-interactive btx-interactive btx-interactive--slide btx-p-border-border btx-interactive--slide-left">
                                            <div class="btx-interactive-space btx-interactive-space--normal btx-light-scheme" style="min-height: 250px">
                                                <div class="btx-background" data-type="image" data-parallaxspeed="0" data-contentfade="" data-mobileparallax="">
                                                    <div class="btx-background-wrapper">
                                                        <div class="btx-background-inner" style="background-image:url(<?php echo e(url($portfolio->negahdari_image)); ?>); background-size:cover; background-position:center center; background-repeat:repeat;"></div>
                                                    </div>
                                                    <div class="btx-background-overlay " style="background-color: #000000; opacity:0.6;"></div>
                                                </div>
                                                <div class="btx-interactive-content" style="padding-top:40px; padding-right:40px; padding-left:40px; padding-bottom:40px;">
                                                ...
                                                <div class="btx-interactive-content" style="padding-top:40px; padding-right:40px; padding-left:40px; padding-bottom:40px;">
                                                    <div class="btx-item js-item-text btx-text btx-center-align btx-primary-font">
                                                        <div class="btx-row" style="margin:0 -30px;">
                                                            <div class="btx-text-content btx-col-12" style="padding:0 30px;">
                                                                <div class="btx-text-content-inner">
                                                                    <br><span style="color: #fff;"><?php echo e($portfolio->negahdari_text); ?></span>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                    ...
                                    <div class="btx-col-4 float-right">
                                        <div class="btx-item js-item-interactive btx-interactive btx-interactive--slide btx-p-border-border btx-interactive--slide-left">
                                            <div class="btx-interactive-space btx-interactive-space--normal btx-light-scheme" style="min-height: 250px">
                                                <div class="btx-background" data-type="image" data-parallaxspeed="0" data-contentfade="" data-mobileparallax="">
                                                    <div class="btx-background-wrapper">
                                                        <div class="btx-background-inner" style="background-image:url(<?php echo e(url($portfolio->time_image)); ?>); background-size:cover; background-position:center center; background-repeat:repeat;"></div>
                                                    </div>
                                                    <div class="btx-background-overlay " style="background-color: #000000; opacity:0.6;"></div>
                                                </div>
                                                <div class="btx-interactive-content" style="padding-top:40px; padding-right:40px; padding-left:40px; padding-bottom:40px;">
                                                            ...
                                                            <div class="btx-text-content btx-col-12" style="padding:0 30px;">
                                                                <div class="btx-text-content-inner">
                                                                    <br><span style="color: #fff;">
                                                                        <?php echo e($portfolio->time_text); ?>
                                    ...
                                    <div class="btx-col-4 float-right">
                                        <div class="btx-item js-item-interactive btx-interactive btx-interactive--slide btx-p-border-border btx-interactive--slide-left">
                                            <div class="btx-interactive-space btx-interactive-space--normal btx-light-scheme" style="min-height: 250px">
                                                <div class="btx-background" data-type="image" data-parallaxspeed="0" data-contentfade="" data-mobileparallax="">
                                                    <div class="btx-background-wrapper">
                                                        <div class="btx-background-inner" style="background-image:url(<?php echo e(url($portfolio->imeni_image)); ?>); background-size:cover; background-position:center center; background-repeat:repeat;"></div>
                                                    </div>
                                                    <div class="btx-background-overlay " style="background-color: #000000; opacity:0.6;"></div>
                                                </div>
                                                <div class="btx-interactive-content" style="padding-top:40px; padding-right:40px; padding-left:40px; padding-bottom:40px;">
                                                ...
                                                <div class="btx-interactive-content" style="padding-top:40px; padding-right:40px; padding-left:40px; padding-bottom:40px;">
                                                    <div class="btx-item js-item-text btx-text btx-center-align btx-primary-font">
                                                        <div class="btx-row" style="margin:0 -30px;">
                                                            <div class="btx-text-content btx-col-12" style="padding:0 30px;">
                                                                <div class="btx-text-content-inner">
                                                                    <br><span style="color: #fff;"><?php echo e($portfolio->imeni_text); ?></span>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                        ...
                                        <div class="btx-container">
                                            <div class="btx-row btx-row--main">
                                                ...
                                                <div class="btx-col-12">
                                                    ...
                                                    <div class="btx-item js-item-text btx-text btx-center-align btx-primary-font">
                                                        <div class="btx-row" style="margin:0 -30px;">
                                                            <span style="font-size: 13px;"><?php echo e($portfolio->fanni_text); ?></span>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="btx-col-1">
...
<?php echo $__env->make('layouts.second', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>