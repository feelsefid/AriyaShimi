                                ...
                                <div class="btx-row btx-row--main btx-row--no-spacing">
                                    ...
                                    <div class="btx-col-6">
                                        ...
                                        <div class="btx-item js-item-box btx-box btx-center-align btx-p-border-border btx-dark-scheme">
                                            <div class="btx-background" data-type="image" data-parallaxspeed="0" data-contentfade="" data-mobileparallax="">
                                                <div class="btx-background-wrapper">
                                                    <div class="btx-background-inner" style="background-image:url(<?php echo e(url(explode(',', $data[0]['image'])[0])); ?>); background-size:cover; background-position:left center; background-repeat:repeat;"></div>
                                                </div>
                                            </div>
                                        ...
                                        <div class="btx-item js-item-box btx-box btx-center-align btx-p-border-border btx-light-scheme">
                                            <div class="btx-background" data-type="color" data-parallaxspeed="0" data-contentfade="" data-mobileparallax="">
                                                <div class="btx-background-wrapper">
                                                    <div class="btx-background-inner" style="background-image:url(<?php echo e(url('/')); ?>/site/upload/bg-nautical.jpg); background-size:cover; background-position:center center; background-repeat:repeat;"></div>
                                                </div>
                                                    ...
                                                    <div class="btx-box-body" style="padding-top:8%; padding-right:16%; padding-left:16%; padding-bottom:8%;">
                                                                    ...
                                                                    <div class="btx-text-content-inner">
                                                                        <span class="font-style text-align-justify direction-rtl" style="font-size: 13px;">
                                                                            <span style="color: rgb(137, 137, 137);">
                                                                                <?php if($data[1]['show_view_more'] == 1): ?>
                                                                                    <?php echo mb_substr($data[1]['text'], 0, $data[1]['summary_character_count']); ?> ...
                                                                                <?php else: ?>
                                                        ...
                                                        <?php if($data[1]['show_view_more'] == 1): ?>
                                                            ...
                                                            <div class="btx-item js-item-button btx-button btx-button--border btx-left-align btx-button-size--medium btx-button-hover--brand btx-button-color--brand">
                                                                <a href="<?php echo e(url('about')); ?>" target="_blank" class="btnx" style="border-radius:40px; border-width:1px;">
                                                                    <?php echo app('translator')->getFromJson('general.view_more'); ?>
                                                                </a>
                                                            </div>
                                                        <?php endif; ?>
                                                    </div>
                                        ...
                                        <div class="btx-item js-item-box btx-box btx-center-align btx-p-border-border btx-light-scheme">
                                            <div class="btx-background" data-type="image" data-parallaxspeed="0" data-contentfade="" data-mobileparallax="">
                                                <div class="btx-background-wrapper">
                                                    <div class="btx-background-inner" style="background-image:url(<?php echo e(url(explode(',', $data[2]['image'])[0])); ?>); background-size:cover; background-position:left center; background-repeat:repeat;"></div>
                                                </div>
                                            </div>
                                            <div class="btx-box-inner" data-height="">
                                                <div class="btx-box-content btx-middle-vertical" style="overflow-y:hidden;">
                                                            ...
                                                            <div class="btx-row" style="margin:0 -30px;">
                                                                <div class="btx-text-content btx-col-12" style="padding:0 30px;">
                                                                    <div class="btx-text-content-inner">
                                                                        <span class="font-style text-align-justify direction-rtl" style="font-size: 13px;">
                                                                            <span style="color: rgb(137, 137, 137);">
                                                                                <?php if($data[3]['show_view_more'] == 1): ?>
                                                                                    <?php echo mb_substr($data[3]['text'], 0, $data[3]['summary_character_count']); ?> ...
                                                                                <?php else: ?>
                                        ...
                                        <div class="btx-item js-item-box btx-box btx-center-align btx-p-border-border btx-light-scheme">
                                            <div class="btx-background" data-type="image" data-parallaxspeed="0" data-contentfade="" data-mobileparallax="">
                                                <div class="btx-background-wrapper">
                                                    <div class="btx-background-inner" style="background-image:url(<?php echo e(url(explode(',', $data[4]['image'])[0])); ?>); background-size:cover; background-position:left center; background-repeat:repeat;"></div>
                                                </div>
                                            </div>
                                            <div class="btx-box-inner" data-height="">
                                                <div class="btx-box-content btx-middle-vertical" style="overflow-y:hidden;">
                                    ...
                                    <div class="btx-col-6">
                                        ...
                                        <div class="btx-item js-item-box btx-box btx-center-align btx-p-border-border btx-light-scheme">
                                            ...
                                            <div class="btx-box-inner" data-height="">
                                                <div class="btx-box-content btx-middle-vertical" style="max-width:700px; overflow-y:hidden;">
                                                    <div class="btx-box-body" style="padding-top:8%; padding-right:16%; padding-left:16%; padding-bottom:8%;">
                                                        <div class="btx-item js-item-heading btx-heading btx-heading--plain btx-right-align">
                                                            <h1 class="btx-heading-text btx-custom_b-font btx-s-text-color btx-s-text-border"><span class="font-style font-style-big" style="font-size: 25px;"><?php echo e($data[0]['name']); ?></span></h1>
                                                        </div>
                                                        <div class="btx-item js-item-divider btx-divider btx-divider--single btx-right-align" style="margin-top:20px; margin-bottom:20px;">
                                                            <div class="btx-divider-line btx-p-border-bg btx-p-border-border" style="width:200px; height:1px; background-color:#dddddd;"></div>
                                                        </div>
                                                            ...
                                                            <div class="btx-row" style="margin:0 -30px;">
                                                                <div class="btx-text-content btx-col-12" style="padding:0 30px;">
                                                                    <div class="btx-text-content-inner">
                                                                        <span class="font-style text-align-justify direction-rtl" style="font-size: 13px;">
                                                                            <span style="color: rgb(137, 137, 137);">
                                                                                <?php if($data[0]['show_view_more'] == 1): ?>
                                                                                    <?php echo mb_substr($data[0]['text'], 0, $data[0]['summary_character_count']); ?> ...
                                                                                <?php else: ?>
                                        ...
                                        <div class="btx-item js-item-box btx-box btx-center-align btx-p-border-border btx-light-scheme">
                                            <div class="btx-background" data-type="image" data-parallaxspeed="0" data-contentfade="" data-mobileparallax="">
                                                <div class="btx-background-wrapper">
                                                    <div class="btx-background-inner" style="background-image:url(<?php echo e(url(explode(',', $data[1]['image'])[0])); ?>); background-size:cover; background-position:right center; background-repeat:repeat;"></div>
                                                </div>
                                            </div>
                                            <div class="btx-box-inner" data-height="">
                                                <div class="btx-box-content btx-middle-vertical" style="overflow-y:hidden;">
                                                            ...
                                                            <div class="btx-row" style="margin:0 -30px;">
                                                                <div class="btx-text-content btx-col-12" style="padding:0 30px;">
                                                                    <div class="btx-text-content-inner">
                                                                        <span class="font-style text-align-justify direction-rtl" style="font-size: 13px;">
                                                                            <span style="color: rgb(137, 137, 137);">
                                                                                <?php if($data[2]['show_view_more'] == 1): ?>
                                                                                    <?php echo mb_substr($data[2]['text'], 0, $data[2]['summary_character_count']); ?> ...
                                                                                <?php else: ?>
                                        ...
                                        <div class="btx-item js-item-box btx-box btx-center-align btx-p-border-border btx-light-scheme">
                                            <div class="btx-background" data-type="image" data-parallaxspeed="0" data-contentfade="" data-mobileparallax="">
                                                <div class="btx-background-wrapper">
                                                    <div class="btx-background-inner" style="background-image:url(<?php echo e(url(explode(',', $data[3]['image'])[0])); ?>); background-size:cover; background-position:right center; background-repeat:repeat;"></div>
                                                </div>
                                            </div>
                                            <div class="btx-box-inner" data-height="">
                                                <div class="btx-box-content btx-middle-vertical" style="overflow-y:hidden;">
                                                            ...
                                                            <div class="btx-row" style="margin:0 -30px;">
                                                                <div class="btx-text-content btx-col-12" style="padding:0 30px;">
                                                                    <div class="btx-text-content-inner">
                                                                        <span class="font-style text-align-justify direction-rtl" style="font-size: 13px;">
                                                                            <span style="color: rgb(137, 137, 137);">
                                                                                <?php if($data[4]['show_view_more'] == 1): ?>
                                                                                    <?php echo mb_substr($data[4]['text'], 0, $data[4]['summary_character_count']); ?> ...
                                                                                <?php else: ?>
                                                        ...
                                                        <a href="#" class="btx-entry-inner anmt-item anmt-zoomout stagger anmt-content-slideup anmt-image-slowzoom">
                                                            <div class="btx-entry-header ">
                                                                <div class="btx-entry-media">
                                                                    <img src="<?php echo e(url(explode(',', $row['image'])[1])); ?>" alt="" width="1024" height="768"  /> </div>
