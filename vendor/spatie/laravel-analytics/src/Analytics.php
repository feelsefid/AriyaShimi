...
sort=-ga:sessions
    */
    public function fetchByCountry(Period $period, int $maxResults = 20): Collection
    {
        $response = $this->performQuery(
            $period,
            'ga:pageviews',
    ...
    public function lastDaysVisits(Period $period, int $maxResults = 20,$start,$end): Collection
    {
        $response = $this->performQuery(
            $period,
            'ga:pageviews',
