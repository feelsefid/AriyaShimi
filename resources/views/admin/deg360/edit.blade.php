...
@section('content')
    {{ Form::model($data, ['url' => url('panel/deg360/' . $data->id), 'class' => 'form-horizontal', 'role' => 'form']) }}
    {{ csrf_field() }}
    {{ method_field('put') }}
        <div class="block-header">
            <div class="row">
                <div class="col-lg-3 col-md-3 col-sm-12">
                    <h2>@lang('side_menu.deg360')</h2>
                </div>
                <div class="col-md-9">
                    <input type="hidden" name="save" id="saveMethod" value="">

                    <a href="{{ url('panel/deg360') }}" class="btn btn-sm btn-back pull-left bg-blush">
                        @lang('form.back')
                    </a>
                        ...
                        <div class="body">
                            ...
                            <div class="tab-content">
                                <div role="tabpanel" class="tab-pane in active" id="details">
                                    ...
                                    <div class="row clearfix">
                                        <label class="col-lg-2 col-md-2 col-sm-4 form-control-label text-left">
                                            @lang('deg360.internal_images_small')
                                        </label>
                                        <div class="col-lg-10 col-md-10 col-sm-8">
                                            <div class="input-group dirleft">
                                                <span class="input-group-addon" onclick="BrowseServer('internal_images_small-1');" style="cursor: pointer" id="span-internal_images_small-1">
                                                    <i class="fa fa-search"></i>
                                                </span>
                                                {{ Form::text('internal_images_small', null, ['class' => 'form-control textright', 'id' => 'internal_images_small-1']) }}
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row clearfix">
                                        <label class="col-lg-2 col-md-2 col-sm-4 form-control-label text-left">
                                            @lang('deg360.internal_images_large')
                                        </label>
                                        <div class="col-lg-10 col-md-10 col-sm-8">
                                            <div class="input-group dirleft">
                                                <span class="input-group-addon" onclick="BrowseServer('internal_images_large-1');" style="cursor: pointer" id="span-internal_images-1">
                                                    <i class="fa fa-search"></i>
                                                </span>
                                                {{ Form::text('internal_images_large', null, ['class' => 'form-control textright', 'id' => 'internal_images_large-1']) }}
                                            </div>
                                        </div>
                                    </div>
    ...
    {{ Form::close() }}
    <script>
        $('#modules, #deg360').addClass('active');
    </script>
@endsection