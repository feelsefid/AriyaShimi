    ...
    <div class="block-header">
        <div class="row">
            <div class="col-lg-3 col-md-3 col-sm-12">
                <h2>
                    @lang('side_menu.deg360')
                </h2>
            </div>
            <div class="col-md-9">
                <input type="hidden" name="save" id="saveMethod" value="">
                @permission('delete.article')
                <a class="btn btn-sm pull-left bg-blush delete" href="{{ url('panel/deg360') }}">
                    <i class="fa fa-trash"></i>
                    @lang('form.delete')
                </a>
                @endpermission
                @permission('edit.article')
                <a class="btn btn-sm bg-blue pull-left actived" href="{{ url('panel/deg360/status') }}">
                    <i class="fa fa-star"></i>
                    @lang('form.active')
                </a>
                <a class="btn btn-sm bg-grey pull-left deactived" href="{{ url('panel/deg360/status') }}">
                    <i class="fa fa-star-o"></i>
                    @lang('form.deactive')
                </a>
                @endpermission
                @permission('create.article')
                <a class="btn btn-sm bg-green pull-left" href="{{ url('panel/deg360/create') }}">
    ...
    <div class="container-fluid">
        ...
        <div class="row clearfix">
            <div class="col-lg-12">
                <div class="card">
                    <div class="header">
                        <h2>@lang('side_menu.deg360_list')</h2>
                    </div>
                    <div class="body">
                        <div class="table-responsive" style="min-height: 450px">
                            <form action="{{ url('panel/deg360') }}" method="GET" id="search">
                                    ...
                                    <thead>
                                        <tr>
                                            ...
                                            <td style="width: 52%" class="text-right">
                                                ...
                                                <input type="text" name="srch_name" style="width: 100%" class="form-control" placeholder="@lang('deg360.title')">
                                            </td>
