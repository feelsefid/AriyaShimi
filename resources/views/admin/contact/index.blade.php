    ...
    <div class="block-header">
        <div class="row">
            ...
            <div class="col-md-9">
                ...
                <a class="btn btn-sm pull-left bg-blush delete" href="{{ url('panel/contact') }}">
                    <i class="fa fa-trash"></i>
                    @lang('form.delete')
                </a>
                @endpermission
                @permission('edit.contact')
                <a class="btn btn-sm bg-blue pull-left actived" href="{{ url('panel/contact/status') }}">
                    <i class="fa fa-star"></i>
                    @lang('form.active')
                </a>
                <a class="btn btn-sm bg-grey pull-left deactived" href="{{ url('panel/contact/status') }}">
                    <i class="fa fa-star-o"></i>
                    @lang('form.deactive')
                </a>
                @endpermission
                @permission('create.contact')
                <a class="btn btn-sm bg-green pull-left" href="{{ url('panel/contact/create') }}">
                ...
                <div class="card">
                    ...
                    <div class="body">
                        <div class="table-responsive" style="min-height: 350px">
                            <form action="{{ url('panel/contact') }}" method="GET" id="search">
                                <table cellpadding="0" cellspacing="0" border="0" class="table table-striped table-bordered table-hover" id="grid">
                                    ...
                                    <tr>
                                        ...
                                        <td style="width: 20%" class="text-right">
                                            ...
                                            <input type="text" name="srch_name" style="width: 100%" class="form-control" placeholder="@lang('contact.title')">
                                        </td>
