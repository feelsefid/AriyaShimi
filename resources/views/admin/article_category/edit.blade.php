...
@section('content')
    {{ Form::model($data, ['url' => url('panel/article_category/' . $data->id), 'class' => 'form-horizontal ajax-submit', 'role' => 'form']) }}
    {{ csrf_field() }}
    {{ method_field('put') }}
    <div class="block-header">
        <div class="row">
            ...
            <div class="col-md-9">
                ...
                <a href="{{ url('panel/article_category') }}" class="btn btn-sm btn-back pull-left bg-blush">
                    @lang('form.back')
                </a>
    ...
    <div class="container-fluid">
        ...
        <div class="row clearfix">
            <div class="col-lg-12">
                <div class="card">
                    <div class="header">
                        <h2>@lang('article.edit_category')</h2>
                    </div>
                    <div class="body">
                        ...
                        <div class="tab-content">
                            <div role="tabpanel" class="tab-pane in active" id="details">
                                ...
                                <div class="row clearfix">
                                    ...
                                    <div class="col-lg-10 col-md-10 col-sm-8">
                                        {{ Form::select('module', $modules, null, ['class' => 'form-control ms', 'placeholder' => '']) }}
                                    </div>
                                </div>
