...
@section('content')
    <div class="block-header">
        <div class="row">
            ...
            <div class="col-md-9">
                ...
                @permission('delete.menu_category')
                <a class="btn btn-sm pull-left bg-blush delete" href="{{ url('panel/menu_category') }}">
                    <i class="fa fa-trash"></i>
                    @lang('form.delete')
                </a>
                @endpermission
                @permission('edit.menu_category')
                <a class="btn btn-sm bg-blue pull-left actived" href="{{ url('panel/menu_category/status') }}">
                    <i class="fa fa-star"></i>
                    @lang('form.active')
                </a>
                <a class="btn btn-sm bg-grey pull-left deactived" href="{{ url('panel/menu_category/status') }}">
                    <i class="fa fa-star-o"></i>
                    @lang('form.deactive')
                </a>
                @endpermission
                @permission('create.menu_category')
                <a class="btn btn-sm bg-green pull-left" href="{{ url('panel/menu_category/create') }}">
    ...
    <div class="container-fluid">
        ...
        <div class="row clearfix">
            <div class="col-lg-12">
                <div class="card">
                    <div class="header">
                        <h2>@lang('side_menu.menu_categories')</h2>
                    </div>
                    <div class="body">
                        <div class="table-responsive" style="min-height: 350px">
                            <form action="{{ url('panel/menu_category') }}" method="GET" id="search">
                                <table cellpadding="0" cellspacing="0" border="0" class="table table-striped table-hover table-bordered" id="grid">
                                    <thead>
                                        <tr>
                                            ...
                                            <td style="width: 72%" class="text-right">
                                                ...
                                                <input type="text" name="srch_name" value="" class="form-control" placeholder="@lang('menu.category_title')">
                                            </td>
                                    ...
                                    <tbody>
                                        @include('admin.menu_category.grid')
                                    </tbody>
                                </table>
                            </form>
                        </div>
    ...
    <script>
        $('#menus, #menu_category').addClass('active');
    </script>
@endsection