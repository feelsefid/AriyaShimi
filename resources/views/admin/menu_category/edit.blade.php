...
@section('content')
    {{ Form::model($data, ['url' => url('panel/menu_category/' . $data->id), 'class' => 'form-horizontal ajax-submit', 'role' => 'form']) }}
    {{ csrf_field() }}
    {{ method_field('put') }}
    <div class="block-header">
        <div class="row">
            ...
            <div class="col-md-9">
                ...
                <a href="{{ url('panel/menu_category') }}" class="btn btn-sm btn-back pull-left bg-blush">
                    @lang('form.back')
                </a>
                            ...
                            <div role="tabpanel" class="tab-pane in active" id="details">
                                <div class="row clearfix">
                                    ...
                                    <div class="col-lg-10 col-md-10 col-sm-8">
                                        {{ Form::select('parent_id', $category, null, ['class' => 'form-control ms', 'placeholder' => '']) }}
                                    </div>
                                </div>
                            ...
                            <div role="tabpanel" class="tab-pane" id="settings">
                                <div class="row clearfix">
                                    ...
                                    <div class="col-lg-10 col-md-10 col-sm-8 btnGroup">
                                        <label for="active" class="btn @if($data->status == 1) btn-success on @else btn-default off @endif">
                                            <input type="radio" value="1" id="active" name="status" @if($data->status == 1) checked @endif>
                                            @lang('form.active')
                                        </label>

                                        <label for="deactive" class="btn @if($data->status == 2) btn-danger on @else btn-default off @endif">
