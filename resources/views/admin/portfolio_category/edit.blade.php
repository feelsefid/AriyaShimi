...
@section('content')
    {{ Form::model($data, ['url' => url('panel/portfolio_category/' . $data->id), 'class' => 'form-horizontal ajax-submit', 'role' => 'form']) }}
    {{ csrf_field() }}
    {{ method_field('put') }}
    <div class="block-header">
        <div class="row">
            ...
            <div class="col-md-9">
                ...
                <a href="{{ url('panel/portfolio_category') }}" class="btn btn-sm btn-back pull-left bg-blush">
                    @lang('form.back')
                </a>
    ...
    <div class="container-fluid">
        ...
        <div class="row clearfix">
            <div class="col-lg-12">
                <div class="card">
                    <div class="header">
                        <h2>@lang('portfolio.edit_category')</h2>
                    </div>
                    <div class="body">
                                    ...
                                    @if(!empty($data->image))
                                        @foreach(explode(',', $data->image) as $row)
                                            <div class="col-sm-12 col-md-6 clone-row" style="float: right">
                                                <a href="{{ url('panel/portfolio/delete_row/' . $data->id) }}" class="text-danger delete-row col-md-1" data-image="{{ $row }}">
