...
@section('content')
    {{ Form::model($data, ['url' => url('panel/user/' . $data->id), 'class' => 'form-horizontal', 'role' => 'form' , 'method' => 'PUT']) }}
    {{ csrf_field() }}
                        ...
                        <div class="tab-content">
                            <div role="tabpanel" class="tab-pane in active" id="details">
                                ...
                                <div class="row clearfix">
                                    ...
                                    <div class="col-lg-10 col-md-10 col-sm-8">
                                        {{ Form::select('roles[]', $roles, $selected_roles, ['class' => 'form-control ms chosen', 'multiple', 'data-placeholder' => trans('forms.chosen-select'), 'id' => 'role']) }}
                                        @if ($errors->has('roles'))
